...
export class GovernanceToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class GovernanceToken extends SmartContract {
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): GovernanceToken__checkpointsResult {
    let result = super.call("checkpoints", [
      EthereumValue.fromAddress(param0),
      EthereumValue.fromUnsignedBigInt(param1)
    ]);

    return new GovernanceToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): CallResult<GovernanceToken__checkpointsResult> {
    ...
    return CallResult.fromValue(
      new GovernanceToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
